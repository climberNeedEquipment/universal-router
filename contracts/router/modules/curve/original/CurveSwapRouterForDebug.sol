...
import {RouterParameters} from 'contracts/router/base/RouterImmutables.sol';

// import 'forge-std/// console.sol';

/// @title Router for Curve v2 Trades
contract CurveSwapRouterForDebug is RouterImmutables, Permit2Payments {
    using SafeCastLib for uint256;
    using SafeCastLib for int256;
    using UniERC20 for address;

    error CurveTooLittleReceived();
    error CurveInvalidParams();
    error CurveInvalidPath();
