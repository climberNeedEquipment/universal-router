...
interface ILendingPoolV2 {
     ...
     **/
    function getConfiguration(address asset) external view returns (DataTypesV2.ReserveConfigurationMap memory);
     ...
     **/
    function getUserConfiguration(address user) external view returns (DataTypesV2.UserConfigurationMap memory);
